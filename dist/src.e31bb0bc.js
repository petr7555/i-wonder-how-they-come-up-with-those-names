...
var $author$project$Main$initialModel = {
	items: _List_fromArray(
		['Matcha', 'Latte', 'Cappuccino', 'Espresso ', 'Mocha', 'Salted Caramel', 'Brownies', 'Chocolate', 'Chai', 'Frappuccino', 'Strawberry', 'Double', 'Vanilla', 'Creme', 'Green Tea', 'Caramel', 'Chocolatey', 'Dark', 'Peanut Butter', 'Chocolate Chip', 'Cheesecake', 'Coconut', 'Ice Cream', 'Macarons', 'Panna Cotta']),
...
var $author$project$Main$RandomNumber1 = function (a) {
	return {$: 'RandomNumber1', a: a};
};
var $author$project$Main$RandomNumber2 = function (a) {
	return {$: 'RandomNumber2', a: a};
};
var $author$project$Main$RandomNumber3 = function (a) {
	return {$: 'RandomNumber3', a: a};
};
		...
		switch (msg.$) {
			case 'FindRandom':
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Main$RandomNumber1,
						A2(
			...
			case 'RandomNumber1':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Main$RandomNumber2,
						A2(
							$elm$random$Random$int,
							0,
							$elm$core$List$length(model.items) - 1)));
			case 'RandomNumber2':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Main$RandomNumber3,
						A2(
							$elm$random$Random$int,
							0,
							$elm$core$List$length(model.items) - 1)));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Get new super fancy name 🍫☕️🍰')
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"FindRandom":[],"RandomNumber1":["Basics.Int"],"RandomNumber2":["Basics.Int"],"RandomNumber3":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});
...
},{"./Main.elm":"Main.elm"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
